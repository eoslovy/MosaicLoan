package com.mosaic.credit.data.consumer;

import org.springframework.kafka.annotation.KafkaListener;
import org.springframework.stereotype.Component;

import com.mosaic.credit.data.domain.DataSource;
import com.mosaic.credit.data.dto.EvaluationStartRequest;
import com.mosaic.credit.data.service.DataService;
...
public class DataConsumer {
    ...
    public void listenCredit(EvaluationStartRequest request) {
        ...
        dataService.processData(request.getCaseId(), request.getMemberId(), DataSource.CREDIT);
    }
