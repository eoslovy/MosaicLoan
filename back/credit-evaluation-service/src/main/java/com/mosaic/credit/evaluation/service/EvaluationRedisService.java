...
import com.mosaic.credit.evaluation.exception.RedisException;
...
public class EvaluationRedisService {
    ...
    public boolean isAlreadyReceived(String caseId, String source) {
        try {
            ...
            throw new RedisException(ErrorCode.REDIS_READ_ERROR, "수신 여부 확인 실패: caseId = " + caseId + ", source = " + source);
        }
    }
    ...
    public void saveReceivedSource(String caseId, String source) {
        try {
            ...
            throw new RedisException(ErrorCode.REDIS_SAVE_ERROR, "수신 소스 저장 실패: caseId = " + caseId + ", source = " + source);
        }
    }
    ...
    public void savePayload(String caseId, String source, EvaluationResultDto result) {
        try {
            ...
            throw new RedisException(ErrorCode.REDIS_SAVE_ERROR, "페이로드 저장 실패: caseId = " + caseId + ", source = " + source);
        }
    }
    ...
    public Optional<EvaluationResultDto> getPayload(String caseId, String source) {
        try {
            ...
            throw new RedisException(ErrorCode.REDIS_READ_ERROR, "페이로드 조회 실패: caseId = " + caseId + ", source = " + source);
        }
    }
