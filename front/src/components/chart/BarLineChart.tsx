...
const BarLineChart: React.FC<BarLineChartProps> = ({
  ...
  const slicedLineData = processedLineData.slice(-displayCount).map((d) => d.value);
      ...
      callbacks: {
        ...
        label: (tooltipItem: any) => {
          ...
          if (dataset.type === "bar") {
            ...
            const totalValue = datasetValues.reduce((sum, val) => sum + val, 0);
