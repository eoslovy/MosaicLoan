...
// 			ServerWebExchangeMatchers.pathMatchers("/api/*/secured/**", "/api/member/**", "/api/account/**",
// 				"/api/contract/**", "/api/mydata/**", "/api/credit/**")
// 		);
//
// 		return http
...
// 			Arrays.asList("http://localhost:3000", "https://j12a608.p.ssafy.io", "http://localhost"));
